...
import EditAkunAdmin from "./Pages/DataPegawai/EditAkunAdmin";
// import KonfirmPengajuanAdmin from "./Pages/Pengajuan/KonfirmPengajuanAdmin";
import DaftarPengajuanCutiAdmin from "./Pages/Pengajuan/DaftarPengajuanCutiAdmin";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="admin" element={<App />}>
          ...
          <Route path="pengajuan_cuti" element={<DaftarPengajuanCutiAdmin />} />
        </Route>
